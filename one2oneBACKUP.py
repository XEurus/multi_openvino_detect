...
class MyWindow(QtWidgets.QMainWindow, MainWindow.Ui_MainWindow):
    ...
    def joinChannel(self):
        ...
        token="007eJxTYLh/tm1Vu3S6/9WVtYdPbW1Su21js3eO9tM9Xe9kdAyVpj1VYEhJNTCyMDJNSTKwMDcxBNGGKZaGJoZmQI6xiUXSzq/3UhsCGRle+KxiZWSAQBCfmcHQyJiBAQC3tiBp"
        channelName="123"
        print(self.rtc.joinChannel(token, channelName, "", 0))
